...
<main>
     ...
     <section>
          <div class="container">
               <div class="row d-flex justify-center justify-content-center ">
                ...
                <div class="col-md-8 col-sm-12  ">
                    <div class="courses-thumb courses-thumb-secondary">
                         ...
                         <div class="team-info">
                                <h3 class=" bike-head flex justify-content-around " >
                                   
                                    <div>
                                         {{ $bike->name }}
                                    </div>
                                    <div>
                                        {{ $bike->brand->name }} Brand
                                    </div>
                                </h3>
                            ...
                            <div>
                                ...
                                @foreach ($bike->features as $feature)
                                    <span class="text text-success h3" >
